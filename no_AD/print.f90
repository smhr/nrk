! **********************************************************************
subroutine printresult(x,y,bz,dbz)
use initializeNRK
  implicit none

  double precision, dimension(nn) ::  x, rho, rhod
  double precision, dimension(nn), intent(out) :: bz
...
!   close(50)
  ...
  do i=1,nn
     ...
     bz(i) = (1.-y(5,i)*y(5,i)/ome2*pd)*b/rho(i)*y(1,i) &
        & - y(5,i)*y(5,i)/ome2*b*y(2,i) &
        & + b*y(3,i)/ome2*(1./rho(i)*rhod(i))
!      write(60,*) x(i), y(1,i)
!      write(70,*) x(i), y(2,i)
!      write(80,*) x(i), y(3,i)
!      write(90,*) x(i), y(4,i)
