...
!                     stop
           ...
           write(6,'(a,2x,3f15.6,i6,e18.5)')'NO: 1st_k, final_k, ome2, iter, amean(ea) =', wave_n, dabs(y(5,nn)), ome2, iter &
             ...
             flush(6)
            if (verbos == 1) then
             write(not_converged_file , '( a15, f10.6, a1, f10.6, a1, i3 )' ) 'not_converged/',dabs(ome2),'_',wave_n,'_',iter
                    ...
                    enddo
                    close(45)
             write(deltaY_file , '( a25, f10.6, a1, f10.6, a1, i3 )' ) 'not_converged/deltaY_',dabs(ome2),'_',wave_n,'_',iter
