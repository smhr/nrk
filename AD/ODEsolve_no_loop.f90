...
!              if (err.lt.acy) then
            write(6,'(a48,3f15.6,i6,e18.5)') 'yes: 1st_k, final_k, ome2, iter ,amean(ea) =', wave_n, y(5,nn), ome2, iter,amean(ea)
                    ...
                    write(output_file , '( a12, f10.6, a1, f10.6, a1, f10.6 )' ) 'all_results/',wave_n,'_',y(5,nn),'_',ome2
                    flush(21)
                    nprevious = 1
...
!                     enddo
                    do i=1, nn
                       write(44,'(f6.3, 7f15.10)') x(i), y(1,i), y(2,i), y(3,i), y(4,i), y(5,i), y(6,i), y(7,i)
                    enddo
                    close(44)
!                     stop
                    exit
