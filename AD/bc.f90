...
!   v(7) = 2
 if (bcType == 431) then
    ...
    v(4) = 6
    v(6) = 2
 elseif (bctype == 433 .or. bctype == 434 .or. bctype == 435 .or. bctype == 436 .or. bctype == 437 &
        & .or. bctype == 438 .or. bctype == 439 .or. bctype == 4310) then
    v(2) = 4
    v(7) = 2
    v(4) = 7
